...
HuiBoard™ is a five or ten key keyboard that is one possible implimentation of the ET Language™. You can think of ET Language as a binary sign language that allows you to type. The system was designed to be mnemonic, fast, efficient, powerful, ergonomic, and easy to learn.
